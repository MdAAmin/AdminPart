...
public class StuSyllabusReadActivity extends AppCompatActivity {
    ...
    private SyllabusReadCustomAdapter customAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customAdapter = new SyllabusReadCustomAdapter(filteredItemList, this);
    ...
    private void fetchItems() {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                progressBar.setVisibility(View.GONE);
                Toast.makeText(StuSyllabusReadActivity.this, "Failed to load data: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
